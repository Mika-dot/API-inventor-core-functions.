...
// WSCADD.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CWSCADDApp, CWinApp)
...
// Единственный объект CWSCADDApp

CWSCADDApp theApp;


// Инициализация CWSCADDApp

BOOL CWSCADDApp::InitInstance()
{
